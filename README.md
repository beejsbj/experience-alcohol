...
- The printer states the facts in dot matrix and condensed mono: the BAC,
  ...
  a barcode. A human annotates in ballpoint: the name, how you're feeling,
  when the next pour is, a loop round "now".
- Drinks are glasses on the rubber bar mat. Tap one to drink it; it drains
  ...
  special on a cocktail napkin.
- Circle a vibe to hold it (barely · relaxed · tipsy) — a highlighter band
  marks it on the chart and a rubber stamp judges the pace: ON PACE /
  EASY NOW / SLOW DOWN / CUT OFF.
...
- On the table: everyone's receipt at a glance, a beer coaster with a QR to
  ...
  for a newcomer. Cut along the scissor line to close the tab and keep the
  PAID receipt.
